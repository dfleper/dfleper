...
### 🛠 Tech Stack
[![My Skills](https://skillicons.dev/icons?i=python,java,html,css,js,ts,mysql,postgres,unity,cs,angular,docker,vscode,eclipse,linux,ubuntu,mint,git,github,figma,firebase)](https://github.com/dfleper?tab=repositories)
